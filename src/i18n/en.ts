...
const en = {
  ...
  auth: {
    ...
    signupSubtitle: 'Start capturing your dance journey',
    displayNameLabel: 'Display Name',
    displayNamePlaceholder: 'e.g. DanceLover99',
    emailLabel: 'Email',
  ...
  appSettings: {
    ...
    // Account Management
    editAccountSection: 'Edit Account',
    editAccountDesc: 'Update your display name, change your password, or delete your account.',
    editDisplayNameTitle: 'Display Name',
    editDisplayNameLabel: 'Display Name',
    editDisplayNamePlaceholder: 'Enter your display name',
    saveDisplayNameBtn: 'Save Name',
    ...
    setPasswordDesc: 'Add a password so you can also log in using your email and password.',
    ...
    deleteAccountDesc: 'Permanently delete your account and all associated dance sessions, audios, and files.',
    deleteAccountBtn: 'Delete Account',
    deleteAccountModalTitle: 'Delete Account Permanently',
    deleteAccountModalWarning: 'This action is irreversible. All your dance sessions, audio recordings, transcripts, summaries, and cloud data will be permanently wiped from our servers and this device.',
    deleteAccountConfirmPrompt: 'To confirm deletion, please type DELETE below:',
  ...
  modals: {
    ...
    shareTopics: 'Topic Tags',
    shareNoTopics: '(No topics added)',
    shareTranscripts: 'Individual Clip Transcripts',
    shareNoTranscripts: '(No audio clips transcribed)',
    shareMedia: 'Include Media',
    shareMediaWarning: 'Tip: For very large video files, you can also use "Export File" below to transfer offline or via AirDrop.',
    ...
    sharedTopicsShared: 'Topics Shared',
    sharedTopicsIncluded: '✓ {count} Topic Tag(s) Included',
  ...
  toast: {
    ...
    failedDownloadAudio: 'Failed to download audio for transcription',
  ...
  onboarding: {
    ...
    demoSessionSubtitle: 'Recap from today\'s lesson',
    demoAudioTranscript: 'Teacher feedback: your weight transfer is collapsing before the turn, delay the step. Keep your frame engaged on the back step. Drill: 10 minutes of slow basic, no partner. Homework: record yourself doing the combo at home and compare.',
    demoAudioFilename: 'Lesson Recap.mp4',
    demoReportStrict1: 'Delay weight transfer before the turn',
    demoReportStrict2: 'Keep frame engaged on the back step',
    demoReportDrill: '10 minutes of slow basic step, no partner',
    demoReportHomework: 'Record yourself doing the combo and compare',
    // Demo Sandbox Banner
    sandboxBannerTitle: 'Interactive Demo Sandbox',
    sandboxBannerDesc: 'Tap any button, card, or note to explore what it does in real lessons.',
    sandboxHintsToggle: 'Hints',
    sandboxDismiss: 'Dismiss',
    guideGotIt: 'Got it',

    // Demo Guide Tags
    guideTagConsolidate: 'Consolidate with AI 🪄',
    guideTagRecord: 'Live Voice Recording 🎙️',
    guideTagUpload: 'Upload Recap 📤',
    guideTagEditing: 'Direct Editing ✏️',
    guideTagDelete: 'Remove Content 🗑️',
    guideTagShare: 'Share Lesson 🔗',
    guideTagExport: 'PDF Export 📄',
    guideTagGallery: 'Media Gallery 🎬',
    guideTagSettings: 'Session Settings ⚙️',
    guideTagGlossary: 'Dance Glossary 🎵',
    guideTagReprocess: 'Reprocess Clip ⚡',
    guideTagProcess: 'Process Recording ⚡',
    guideTagReorder: 'Reorder Cards ↕️',
    guideTagTopics: 'Lesson Topics 🏷️',
    guideTagNotes: 'Personal Notes 📝',
    guideTagAudioPlayer: 'Audio Playback 🎧',

    // Demo Tooltips
    demoTooltipConsolidate: '🪄 Experience the Zoutty magic! Consolidating turns all your clips and recap notes into a structured AI lesson with corrections, drills, and homework.',
    demoTooltipRecord: '💡 Tap here to record a live audio. We recommend keeping clips under 90 seconds.',
    demoTooltipUpload: '💡 Tap here to upload your recap video or audio from your last lesson. Zoutty accepts MP4, MOV, MP3, M4A and more.',
    demoTooltipTopics: '💡 Topics organize key concepts across lessons. The AI tags them automatically, or you can add your own.',
    demoTooltipNotes: '💡 Keep quick personal notes or practice reminders alongside your AI report and clips.',
    demoTooltipEdit: '💡 In your own sessions, tap any text or bullet point to edit it directly.',
    demoTooltipDelete: '💡 In your own sessions, use this to remove clips or notes you no longer need.',
    demoTooltipShare: '💡 Share your session via link or a 6-character code with your partner or teacher—no account required.',
    demoTooltipExport: '💡 Export a clean, printable PDF report with all your corrections, drills, and homework.',
    demoTooltipGallery: '💡 Attach demonstration videos and lesson photos to keep all visual references in one place.',
    demoTooltipSettings: '💡 Adjust session details: change the date, assign a folder, or select specific dance style glossaries.',
    demoTooltipGlossary: '💡 Shows the active dance style. Zoutty detects the style and applies the correct dance vocabulary to your report.',
    demoTooltipReprocess: '💡 Re-run AI transcription and extraction on this clip if you updated glossary settings or want a fresh take.',
    demoTooltipProcess: '💡 Transcribes this individual recording and extracts technical corrections, drills, and homework.',
    demoTooltipReorder: '💡 Toggle reorder mode to drag and arrange your report, audio clips, and notes in any order.',
    demoTooltipAudioPlayer: '💡 Listen back to your recorded voice notes and lesson clips here.',
    ...
    tourWelcomeTitle: 'Bring Your Recap to Zoutty',
    tourWelcomeSubtitle: 'You recorded it on your phone. Now bring it here! Zoutty turns your recap video into a structured AI lesson with corrections, drills, and homework. Automatically. Take a quick tour to see how.',
    ...
    step1Title: 'Start a New Lesson',
    step1Desc: 'Tap here to create a new lesson session. This is where your recap video and notes will live.',
    step1Tip: 'You can organize lessons into folders - great for grouping by teacher, style, or event!',

    step2Title: 'Upload Your Recap Video 📤',
    step2Desc: 'Recorded a video at your last lesson, workshop, or festival? Tap here to import it. Zoutty accepts video and audio files up to 3 minutes and transcribes them automatically.',
    step2Tip: 'You can also record a live voice note during practice. Tap the microphone button for that!',

    step3Title: 'Record Live Notes 🎙️',
    step3Desc: 'Want to capture something in the moment, like a tip from your teacher, a musical cue, or a combo you just learned? Tap here to record a quick voice note.',
    step3Tip: 'Keep clips under 90 seconds for best quality. You can add as many as you need!',

    step4Title: 'Generate Your Lesson 🪄',
    step4Desc: 'Once you have added all your videos and voice notes, tap this button. Zoutty will transcribe and analyze everything and build a structured lesson with key corrections, drills, and homework.',
    step4Tip: 'Add all your content first, then tap Generate once at the end. Zoutty processes everything together and applies the correct dance terminology automatically!',

    step5Title: 'Share Your Lesson 🔗',
    step5Desc: 'Send your structured lesson to your dance partner, teacher, or study group. They get the full session, clips, notes, and all.',
    step5Tip: 'Share via a 6-character code or a direct link. No account needed for the recipient!',

    step6Title: 'Your Demo Lesson is Ready! 🎉',
    step6Desc: 'This is what Zoutty does with a recap video. A fully structured lesson with corrections, drills, and homework, ready to review, edit, and share. Explore it freely.',
    step6SandboxNotice: 'This demo lesson stays in your list so you can explore and edit freely. Delete it whenever you want, or keep it as a reference!',
    step6Tip: 'Tap any element of the demo session for more info. Now drop in your own recap and see it happen for real!',

    tourFinishedToast: '🎉 Tour complete! Drop in your first recap to get started.',
    tourSkippedToast: 'Tour skipped. You can replay it anytime from Settings.',
  ...
  billing: {
    ...
    plans: {
      ...
      choosePlanSubtitle: 'Unlock higher AI quotas, smart lesson organization, and full export capabilities.',
      freeTitle: 'Free Plan',
      freeName: 'Free Plan',
      freeDesc: 'Try out AI transcription and consolidate up to 3 sessions.',
      plusTitle: 'Zoutty Plus',
      plusName: 'Zoutty Plus',
      plusDesc: '20 AI sessions and 200 clips per month with full export & organization.',
    ...
    manage: {
      ...
      pendingDowngradeTitle: 'Scheduled Downgrade',
      pendingDowngradeSectionDesc: 'Your plan is scheduled to switch to Student on {date}. You can cancel this downgrade at any time before then to keep your Teacher plan without interruption.',
      keepTeacherPlanBtn: 'Keep Teacher Plan (Cancel Downgrade)',
      processingCancelDowngrade: 'Cancelling downgrade...',
      cancelDowngradeSuccess: 'Downgrade cancelled! You will continue on the Teacher plan.',
      cancelDowngradeError: 'Failed to cancel downgrade. Please try again.',
      ...
      reactivateSuccessToast: 'Subscription reactivated successfully!',
      reactivateErrorToast: 'Failed to reactivate subscription.',
      cancelPendingToast: 'Subscription will cancel at the end of the billing period.',
      ...
      cancelConsequenceRevertFree: 'After {date}, your account will revert to the Free Plan (3 lifetime sessions, 15 lifetime clips).',
    ...
    limits: {
      ...
      upgradeAction: 'Upgrade to Zoutty Plus',
      upgradeStudent: 'Get Zoutty Plus ({price})',
      upgradePlus: 'Get Zoutty Plus ({price})',
      studentFeature: '20 sessions · 200 clips / mo · €1/friend',
      plusFeature: '20 sessions · 200 clips / mo · €1/friend',
      ...
      unlockStudentHeading: 'Unlock Full Access with Zoutty Plus ({price})',
      unlockPlusHeading: 'Unlock Full Access with Zoutty Plus ({price})',
      featureStudentSessions: '20 AI Session consolidations and 200 clips every month',
      featurePlusSessions: '20 AI Session consolidations and 200 clips every month',
    ...
    referrals: {
      ...
      plusCreditDesc: '€1 off per upcoming monthly payment.',
      ...
      rewardDescPlus: 'Each paid subscriber you refer gives you a €1 discount credit. Credits accumulate and are applied as €1 off each upcoming monthly invoice until exhausted.',
      ...
      plusDeductionSingle: 'Will deduct €1 on your next monthly payment.',
      studentDeductionSingle: 'Will deduct €1 on your next monthly payment.',
      plusDeductionMulti: '€1 off per upcoming payment (will deduct €1 for the next {months} months).',
    ...
    dev: {
      ...
      panelSubtitle: 'Override tiers, simulate billing events, and test limits safely.',
      badgeSandbox: 'Sandbox',
      passwordModalTitle: 'Test Lab Access',
      passwordModalSubtitle: 'Enter password to access developer tools and test sandbox.',
      passwordPromptLabel: 'Password',
      passwordPlaceholder: 'Enter password',
      incorrectPassword: 'Incorrect password. Access denied.',
      unlockBtn: 'Unlock',
      lockBtn: 'Lock Test Lab',
      mockBadge: 'Mock',
      ...
      presetPlus: 'Zoutty Plus (20/mo)',
      presetStudent: 'Zoutty Plus (20/mo)',
