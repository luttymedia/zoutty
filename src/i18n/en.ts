...
const en = {
  ...
  billing: {
    ...
    plans: {
      ...
      studentDesc: '20 AI sessions per month with full export & organization.',
      studentPrice: '€2.99 / month',
      teacherTitle: 'Teacher Plan',
      teacherDesc: '100 AI sessions per month with teacher organization & sharing infrastructure.',
    ...
    limits: {
      recordingApproachingLimit: 'Approaching 3-minute recording limit',
    ...
    referrals: {
      ...
      teacherCreditDesc: '€2 credit per referral (up to €8/month).',
