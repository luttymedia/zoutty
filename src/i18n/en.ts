...
const en = {
  ...
  onboarding: {
    ...
    // Demo Tooltips
    demoTooltipConsolidate: '🪄 Experience the Zoutty magic! Consolidating turns all your clips and recap notes into a structured AI lesson.',
    ...
    demoTooltipTopics: '💡 Topics are added automatically when consolidating with AI, and you can also add or modify them manually.',
    demoTooltipNotes: '💡 In this demo session you can explore your lesson notes, edit items, or add notes in your own sessions.',
