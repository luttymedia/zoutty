...
const en = {
  ...
  appSettings: {
    ...
    offlineGuide2: 'AI transcriptions and summaries will automatically consolidate once an internet connection is available.',
  ...
  billing: {
    ...
    manage: {
      ...
      upgradeConfirmDesc: 'You are about to upgrade to the {targetPlan}. You will be charged a prorated amount immediately, and your quota will increase instantly.',
    ...
    usage: {
      ...
      cancelsOn: 'Cancels on {date}',
      downgradesOn: 'Downgrades to Student on {date}',
    ...
    topup: {
      ...
      confirmBtn: 'Proceed to Checkout (€5.00)',
