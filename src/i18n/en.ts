...
const en = {
  ...
  billing: {
    ...
    manage: {
      ...
      upgradeToTeacherDesc: 'Unlock 100 AI sessions/month, infinite audio clips, and €2 referral discounts.',
      ...
      downgradeLossClips: 'Audio clips capped at 200 / month (currently Infinite)',
    ...
    usage: {
      ...
      unlimitedClips: 'Infinite clips',
      infinite: 'infinite',
      infiniteUppercase: 'Infinite',
    ...
    referrals: {
      ...
      freeBoostDesc: '+{sessions} sessions / +{clips} clips remaining in your boost window ({days} days left).',
      creditsBalance: '€{amount} referral discount balance',
      studentCreditDesc: '€1 off per upcoming monthly payment.',
      teacherCreditDesc: '€2 credit per referral.',
      ...
      rewardDescFree: 'When a friend signs up with your link and subscribes, you unlock a 10-day Boost Window granting +2 AI consolidations & +10 clips!',
      rewardDescStudent: 'Each paid subscriber you refer gives you a €1 discount credit, applied as €1 off per upcoming monthly invoice!',
      rewardDescTeacher: 'Each paid subscriber gives you a €2 credit discount on your monthly invoice!',
    },
    dev: {
      ...
      applyOverrides: 'Save & Apply Overrides',
