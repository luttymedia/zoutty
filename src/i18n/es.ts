...
const es: Translations = {
  ...
  billing: {
    ...
    plans: {
      ...
      studentDesc: '20 sesiones con IA al mes con exportación y organización completa.',
      studentPrice: '2,99 € / mes',
      teacherTitle: 'Plan Profesor',
      teacherDesc: '100 sesiones con IA al mes con infraestructura de organización de alumnos y compartir.',
    ...
    limits: {
      recordingApproachingLimit: 'Acercándote al límite de 3 minutos de grabación',
    ...
    referrals: {
      ...
      teacherCreditDesc: '2 € de crédito por referido (hasta 8 €/mes).',
