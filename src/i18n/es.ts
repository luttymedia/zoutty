...
const es: Translations = {
  ...
  billing: {
    ...
    manage: {
      ...
      upgradeToTeacherDesc: 'Desbloquea 100 sesiones de IA al mes, audios infinitos y 2 € de descuento por amigo referido.',
      ...
      downgradeLossClips: 'Audios limitados a 200 / mes (actualmente Infinitos)',
    ...
    usage: {
      ...
      unlimitedClips: 'Audios infinitos',
      infinite: 'infinitos',
      infiniteUppercase: 'Infinitos',
    ...
    referrals: {
      ...
      freeBoostDesc: '+{sessions} sesiones / +{clips} audios restantes en tu periodo de impulso (quedan {days} días).',
      creditsBalance: '{amount} € en saldo de descuento por referidos',
      studentCreditDesc: '1 € de descuento por cada próximo pago mensual.',
      teacherCreditDesc: '2 € de crédito por referido.',
      ...
      rewardDescFree: '¡Cuando un amigo se registre con tu enlace y se suscriba, desbloquearás un periodo de impulso de 10 días con +2 consolidaciones con IA y +10 audios!',
      rewardDescStudent: '¡Cada suscriptor referido te da un crédito de 1 € de descuento para tus próximas facturas mensuales!',
      rewardDescTeacher: '¡Cada suscriptor referido te da 2 € de crédito de descuento en tu factura mensual!',
    },
    dev: {
      ...
      applyOverrides: 'Guardar y Aplicar Cambios',
