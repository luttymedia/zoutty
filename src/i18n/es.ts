...
const es: Translations = {
  ...
  modals: {
    ...
    shareTopics: 'Etiquetas de temas',
    shareNoTopics: '(Sin temas añadidos)',
    ...
    shareMediaWarning: 'Consejo: Para archivos de video muy grandes, también puedes usar "Exportar Archivo" abajo para transferirlos sin conexión o por AirDrop.',
    ...
    sharedTopicsShared: 'Temas compartidos',
    sharedTopicsIncluded: '✓ {count} etiqueta(s) de tema incluida(s)',
  ...
  toast: {
    ...
    failedDownloadAudio: 'Error al descargar el audio para la transcripción',
  ...
  onboarding: {
    ...
    demoSessionSubtitle: 'Resumen de la clase de hoy',
    demoAudioTranscript: 'Corrección del profe: tu transferencia de peso se cae antes del giro, retrasa el paso. Mantén el marco activo en el paso hacia atrás. Ejercicio: 10 minutos de paso básico solo, tempo lento. Tarea: grábate haciendo la combinación en casa y compara.',
    demoAudioFilename: 'Resumen de Clase.mp4',
    demoReportStrict1: 'Retrasar la transferencia de peso antes del giro',
    demoReportStrict2: 'Mantener el marco activo en el paso hacia atrás',
    demoReportDrill: '10 minutos de paso básico solo, sin pareja',
    demoReportHomework: 'Grabarte haciendo la combinación y comparar',
    // Demo Sandbox Banner
    sandboxBannerTitle: 'Modo Demostración Interactivo',
    sandboxBannerDesc: 'Toca cualquier botón, tarjeta o nota para descubrir qué hace en tus clases reales.',
    sandboxHintsToggle: 'Pistas',
    sandboxDismiss: 'Ocultar',
    guideGotIt: 'Entendido',

    // Demo Guide Tags
    guideTagConsolidate: 'Consolidar con IA 🪄',
    guideTagRecord: 'Grabación en directo 🎙️',
    guideTagUpload: 'Subir resumen 📤',
    guideTagEditing: 'Edición directa ✏️',
    guideTagDelete: 'Eliminar contenido 🗑️',
    guideTagShare: 'Compartir clase 🔗',
    guideTagExport: 'Exportar PDF 📄',
    guideTagGallery: 'Galería multimedia 🎬',
    guideTagSettings: 'Ajustes de clase ⚙️',
    guideTagGlossary: 'Glosario de baile 🎵',
    guideTagReprocess: 'Reprocesar clip ⚡',
    guideTagProcess: 'Procesar grabación ⚡',
    guideTagReorder: 'Reordenar tarjetas ↕️',
    guideTagTopics: 'Temas de clase 🏷️',
    guideTagNotes: 'Notas personales 📝',
    guideTagAudioPlayer: 'Reproducción de audio 🎧',

    // Demo Tooltips
    demoTooltipConsolidate: '🪄 ¡Experimenta la magia de Zoutty! Al consolidar, todos tus clips y notas se transforman en una clase estructurada con IA: correcciones, ejercicios y tareas.',
    ...
    demoTooltipUpload: '💡 Toca aquí para subir tu video o audio de resumen de la última clase. Zoutty acepta MP4, MOV, MP3, M4A y más.',
    demoTooltipTopics: '💡 Los temas organizan conceptos clave entre clases. La IA los etiqueta automáticamente, o puedes añadir los tuyos.',
    demoTooltipNotes: '💡 Guarda notas personales rápidas o recordatorios de práctica junto a tu informe de IA y clips.',
    demoTooltipEdit: '💡 En tus clases reales, toca cualquier texto o punto para editarlo directamente.',
    demoTooltipDelete: '💡 En tus clases reales, usa esto para eliminar clips o notas que ya no necesites.',
    demoTooltipShare: '💡 Comparte tu clase por enlace o código de 6 caracteres con tu pareja o profesor, ¡sin necesidad de cuenta!',
    demoTooltipExport: '💡 Exporta un informe en PDF listo para imprimir con todas tus correcciones, ejercicios y tareas.',
    demoTooltipGallery: '💡 Adjunta videos de demostración y fotos para tener todas las referencias visuales de tu clase en un solo lugar.',
    demoTooltipSettings: '💡 Ajusta los detalles de la clase: cambia la fecha, asígnala a una carpeta o selecciona glosarios de baile específicos.',
    demoTooltipGlossary: '💡 Muestra el estilo de baile activo. Zoutty detecta el estilo y aplica el vocabulario técnico correcto en tu informe.',
    demoTooltipReprocess: '💡 Vuelve a transcribir y extraer este clip si cambiaste el glosario o deseas regenerar el contenido.',
    demoTooltipProcess: '💡 Transcribe esta grabación individual y extrae correcciones técnicas, ejercicios y tareas.',
    demoTooltipReorder: '💡 Activa el modo de reordenar para arrastrar y organizar tu informe, audios y notas en el orden que prefieras.',
    demoTooltipAudioPlayer: '💡 Escucha tus notas de voz y clips de audio grabados en tus clases aquí.',
    ...
    tourWelcomeTitle: 'Trae tu Resumen a Zoutty',
    tourWelcomeSubtitle: 'Lo grabaste con tu móvil. ¡Ahora tráelo aquí! Zoutty convierte tu video resumen en una clase estructurada con IA: correcciones, ejercicios y tareas. Automáticamente. Haz el tour rápido para ver cómo.',
    ...
    step1Title: 'Crear una Nueva Clase',
    step1Desc: 'Toca aquí para crear una nueva sesión de clase. Aquí es donde vivirán tu video resumen y tus notas.',
    step1Tip: 'Puedes organizar tus clases en carpetas - ideal para agrupar por profe, estilo o evento!',

    step2Title: 'Sube tu Video Resumen 📤',
    step2Desc: '¿Grabaste un video en tu última clase, taller o festival? Toca aquí para importarlo. Zoutty acepta videos y audios de hasta 3 minutos y los transcribe automáticamente.',
    step2Tip: 'También puedes grabar una nota de voz en directo durante la práctica. Para eso toca el botón del micrófono!',

    step3Title: 'Graba Notas en Directo 🎙️',
    step3Desc: '¿Quieres capturar algo en el momento, como un consejo del profe, una clave musical o una combinación que acabas de aprender? Toca aquí para grabar una nota rápida.',
    step3Tip: 'Mantén los clips por debajo de 90 segundos para mejor calidad. Puedes añadir todos los que necesites!',

    step4Title: 'Genera tu Clase 🪄',
    step4Desc: 'Una vez que hayas añadido todos tus videos y notas de voz, toca este botón. Zoutty transcribirá y analizará todo y construirá una clase estructurada con correcciones, ejercicios y tareas.',
    step4Tip: 'Añade todo tu contenido primero y toca Generar una sola vez al final. Zoutty procesa todo junto y aplica la terminología correcta de tu estilo automáticamente!',

    step5Title: 'Comparte tu Clase 🔗',
    step5Desc: 'Envía tu clase estructurada a tu compañero de baile, profe o grupo de estudio. Reciben la sesión completa, clips, notas y todo.',
    step5Tip: 'Comparte con un código de 6 caracteres o un enlace directo. La otra persona no necesita cuenta!',

    step6Title: '¡Tu Clase de Demostración está Lista! 🎉',
    step6Desc: 'Esto es lo que Zoutty hace con un video resumen. Una clase completamente estructurada con correcciones, ejercicios y tareas, lista para revisar, editar y compartir. Explórala libremente.',
    step6SandboxNotice: 'Esta clase de demostración se queda en tu lista para que puedas explorar y editar libremente. Bórrala cuando quieras, o consérvala como referencia!',
    step6Tip: 'Toca cualquier elemento de la sesión de muestra para más información. Ahora sube tu propio resumen y observa cómo ocurre de verdad!',

    tourFinishedToast: '🎉 Tour completado! Sube tu primer resumen para empezar.',
    tourSkippedToast: 'Tour omitido. Puedes repetirlo en cualquier momento desde Ajustes.',
  ...
  billing: {
    ...
    plans: {
      ...
      choosePlanSubtitle: 'Desbloquea mayores cuotas de IA, organización inteligente y exportación completa.',
      freeTitle: 'Plan Gratuito',
      freeName: 'Plan Gratuito',
      freeDesc: 'Prueba la transcripción con IA y consolida hasta 3 sesiones.',
      plusTitle: 'Zoutty Plus',
      plusName: 'Zoutty Plus',
      plusDesc: '20 sesiones con IA y 200 audios al mes con exportación y organización completa.',
      plusPrice: '2,99 € / mes',
      studentTitle: 'Zoutty Plus',
      studentName: 'Zoutty Plus',
    ...
    manage: {
      ...
      reactivateSuccessToast: '¡Suscripción reactivada con éxito!',
      reactivateErrorToast: 'No se pudo reactivar la suscripción.',
      cancelPendingToast: 'La suscripción se cancelará al final del periodo de facturación.',
      cancelErrorToast: 'No se pudo cancelar la suscripción.',
      ...
      cancelConsequenceRevertFree: 'Después del {date}, tu cuenta pasará al Plan Gratuito (3 sesiones y 15 audios históricos).',
    ...
    limits: {
      ...
      upgradeAction: 'Obtener Zoutty Plus',
      upgradeStudent: 'Obtener Zoutty Plus ({price})',
      upgradePlus: 'Obtener Zoutty Plus ({price})',
      studentFeature: '20 sesiones · 200 audios / mes · 1 €/amigo',
      plusFeature: '20 sesiones · 200 audios / mes · 1 €/amigo',
      ...
      unlockStudentHeading: 'Desbloquea Acceso Total con Zoutty Plus ({price})',
      unlockPlusHeading: 'Desbloquea Acceso Total con Zoutty Plus ({price})',
      featureStudentSessions: '20 consolidaciones con IA y 200 audios al mes',
      featurePlusSessions: '20 consolidaciones con IA y 200 audios al mes',
    ...
    referrals: {
      ...
      plusCreditDesc: '1 € de descuento por cada próximo pago mensual.',
      ...
      rewardDescPlus: 'Cada suscriptor de pago referido te otorga 1 € de crédito de descuento. Los créditos se acumulan y se aplican como 1 € de descuento en cada factura mensual hasta agotarse.',
      ...
      plusDeductionSingle: 'Se descontará 1 € en tu próximo pago mensual.',
      studentDeductionSingle: 'Se descontará 1 € en tu próximo pago mensual.',
      plusDeductionMulti: '1 € de descuento por pago (se descontará 1 € durante los próximos {months} meses).',
    ...
    dev: {
      ...
      panelSubtitle: 'Modifica niveles, simula eventos de facturación y prueba límites de forma segura.',
      badgeSandbox: 'Sandbox',
      passwordModalTitle: 'Acceso al Laboratorio de Pruebas',
      passwordModalSubtitle: 'Introduce la contraseña para acceder a las herramientas de desarrollo y sandbox.',
      passwordPromptLabel: 'Contraseña',
      passwordPlaceholder: 'Introduce la contraseña',
      incorrectPassword: 'Contraseña incorrecta. Acceso denegado.',
      unlockBtn: 'Desbloquear',
      lockBtn: 'Bloquear Laboratorio',
      mockBadge: 'Simulador',
      ...
      presetPlus: 'Zoutty Plus (20/mes)',
      presetStudent: 'Zoutty Plus (20/mes)',
