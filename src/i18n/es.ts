...
const es: Translations = {
  ...
  onboarding: {
    ...
    // Demo Tooltips
    demoTooltipConsolidate: '🪄 ¡Experimenta la magia de Zoutty! Al consolidar, todos tus clips y notas se transforman en una clase estructurada con IA.',
    ...
    demoTooltipTopics: '💡 Los temas se añaden automáticamente al consolidar con IA, y también puedes modificarlos o añadirlos manualmente.',
    demoTooltipNotes: '💡 En esta clase de muestra puedes explorar notas de lección, editar elementos, o añadir notas en tus propias clases.',
