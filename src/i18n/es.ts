...
const es: Translations = {
  ...
  appSettings: {
    ...
    offlineGuide2: 'Las transcripciones y resúmenes de IA se consolidarán automáticamente tan pronto como haya conexión a internet.',
  ...
  billing: {
    ...
    manage: {
      ...
      upgradeConfirmDesc: 'Estás a punto de mejorar al {targetPlan}. Se te cobrará una cantidad prorrateada inmediatamente y tu cuota aumentará al instante.',
    ...
    usage: {
      ...
      cancelsOn: 'Se cancela el {date}',
      downgradesOn: 'Cambia a Estudiante el {date}',
    ...
    topup: {
      ...
      confirmBtn: 'Proceder al Pago (€5.00)',
