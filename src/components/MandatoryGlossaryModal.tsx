      ...
      <div className="glass p-6 max-w-md w-full rounded-2xl shadow-xl flex flex-col max-h-[90vh]">
        ...
        <div className="shrink-0 pt-4 border-t border-white/10">
          <button
            ...
            className="w-full h-9 px-4.5 rounded-full bg-brand hover:bg-brand/90 text-bg-dark text-xs sm:text-sm font-semibold transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-brand/20 active:scale-95 cursor-pointer"
          >
