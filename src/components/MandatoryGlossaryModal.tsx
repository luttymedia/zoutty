      ...
      <div className="glass p-6 max-w-md w-full rounded-2xl shadow-xl flex flex-col max-h-[90vh]">
        ...
        <div className="shrink-0 pt-4 border-t border-white/10">
          <button
            ...
            className="w-full px-4 py-4 rounded-xl bg-brand hover:bg-brand/90 text-bg-dark text-base transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-brand/20"
          >
