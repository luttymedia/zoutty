    ...
    <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex flex-col items-center justify-center z-[80] p-4 sm:p-6 overflow-y-auto" onClick={onClose}>
      ...
      >
        ...
        <div className="mb-5 text-left">
          <div className="text-[10px] uppercase text-purple-300/80 tracking-wider mb-2 flex items-center gap-1.5">
          ...
          <div className="grid grid-cols-2 gap-2.5">
            ...
            <div className="p-3 rounded-2xl bg-purple-950/30 border border-purple-500/20 flex flex-col">
              ...
              <span className="text-lg text-white mt-0.5">{totalReferrals}</span>
            </div>
            ...
            {tier === 'free' ? (
              ...
              <div className="p-3 rounded-2xl bg-purple-950/30 border border-purple-500/20 flex flex-col">
                ...
                <span className="text-lg text-purple-300 mt-0.5">€{creditsBalance}.00</span>
              </div>
            )}
          </div>
          ...
          {pendingRefundCount > 0 && (
            <div className="mt-2.5 px-3 py-2 rounded-xl bg-amber-500/10 border border-amber-500/20 text-[11px] text-amber-300 flex items-center justify-between">
              ...
              <span className="">{pendingRefundCount}</span>
            </div>
          )}
        ...
        {tier === 'free' && boostActive && boostExpiresAt && (
          <div className="p-3.5 rounded-2xl bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-xs mb-5 flex items-center gap-2.5 text-left">
            <Sparkles className="w-5 h-5 shrink-0" />
            <div>
              <div className="">{t('billing.referrals.freeBoostTitle')}</div>
        ...
        <div className="space-y-2.5 mb-5">
          <label className="text-[11px] uppercase tracking-wider text-white/50 block text-left">
          ...
          <div className="flex items-center gap-2 p-2 pl-4 rounded-2xl bg-zinc-900 border border-white/15">
            <span className="font-mono text-base text-brand tracking-widest flex-1 text-left select-all">
